package com.evirgenoguz.run.data
...
class SyncRunWorkerScheduler(
    ...
    override suspend fun scheduleSync(type: SyncRunScheduler.SyncType) {
        when (type) {
            ...
            is SyncRunScheduler.SyncType.DeleteRuns -> scheduleDeleteRunWorker(type.runId)
    ...
    override suspend fun cancelAllSyncs(type: SyncRunScheduler.SyncType) {
