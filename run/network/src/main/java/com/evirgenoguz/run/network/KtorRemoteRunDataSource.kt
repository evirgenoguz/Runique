...
import com.evirgenoguz.core.data.networking.constructRoute
import com.evirgenoguz.core.data.networking.delete
import com.evirgenoguz.core.data.networking.get
...
import com.evirgenoguz.core.domain.util.map
...
class KtorRemoteRunDataSource(
    ...
    override suspend fun deleteRun(id: String): Result<Unit, DataError.Network> {
