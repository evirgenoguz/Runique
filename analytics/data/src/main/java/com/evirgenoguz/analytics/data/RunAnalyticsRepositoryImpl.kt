package com.evirgenoguz.analytics.data

import com.evirgenoguz.analytics.domain.AnalyticsValues
...
class RunAnalyticsRepositoryImpl(
    ...
    override suspend fun getAnalyticsValues(): AnalyticsValues {
        return withContext(Dispatchers.IO) {
            ...
            val avgPacePerRun = async { analyticsDao.getAvgDistancePerRun() }
